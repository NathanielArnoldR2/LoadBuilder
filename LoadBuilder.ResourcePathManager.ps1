...
function Get-LoadBuilderPath ([string]$Token) {
...
New-PathObj RealizedLoads      Directory -AutoCreate
New-PathObj RealizedLoads_Base Directory -AutoCreate
New-PathObj PerfMonLogs        Directory -AutoCreate

New-PathObj VMExport           Directory -AutoCreate
New-PathObj LoadExport         Directory -AutoCreate
New-PathObj LoadExport_Fast    Directory -AutoCreate

New-Alias -Name Set-Path -Value Set-LoadBuilderPath
New-Alias -Name Get-Path -Value Get-LoadBuilderPath